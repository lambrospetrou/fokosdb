/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 83b7839f3dd1e3d90a24720f56cea60d)
// Runtime types generated with workerd@1.20260910.1 2026-05-23 nodejs_compat
interface __BaseEnv_Env {
	COUNTER_PARTITION_DO: DurableObjectNamespace<import("./index").CounterPartitionDO>;
	SEARCH_PARTITION_DO: DurableObjectNamespace<import("./index").SearchPartitionDO>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "CounterPartitionDO" | "SearchPartitionDO" | "PartitionDO" | "TransactionCoordinatorDO";
	}
