/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c src/examples/http-api/wrangler.jsonc src/examples/http-api/worker-configuration.d.ts` (hash: cc92ebda908c2aa0fe0f2b0fe2823974)
...
interface __BaseEnv_Env {
	...
	PARTITION_DO: DurableObjectNamespace<import("./index").PartitionDO>;
	TRANSACTION_COORDINATOR_DO: DurableObjectNamespace<import("./index").TransactionCoordinatorDO>;
	CUSTOM_PARTITION_DO: DurableObjectNamespace<import("./index").CustomPartitionDO>;
}
