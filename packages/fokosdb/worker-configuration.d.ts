/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0f77041b1b44610e46053c8fda0e03b)
// Runtime types generated with workerd@1.20260923.1 2026-05-23 nodejs_compat
interface __BaseEnv_Env {
	FOKOS_SHOULD_FETCH_COLO_INFO: true;
	PARTITION_DO: DurableObjectNamespace<import("./test/worker-entry").PartitionDO>;
	TRANSACTION_COORDINATOR_DO: DurableObjectNamespace<import("./test/worker-entry").TransactionCoordinatorDO>;
	CUSTOM_PARTITION_DO: DurableObjectNamespace<import("./test/worker-entry").CustomPartitionDO>;
	CONTROLLED_PARTITION_DO: DurableObjectNamespace<import("./test/worker-entry").ControlledPartitionDO>;
	CONTROLLED_TRANSACTION_COORDINATOR_DO: DurableObjectNamespace<import("./test/worker-entry").ControlledTransactionCoordinatorDO>;
	ERROR_PROBE_DO: DurableObjectNamespace<import("./test/worker-entry").ErrorProbeDO>;
	COUNTER_PARTITION_DO: DurableObjectNamespace<import("./test/worker-entry").CounterPartitionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test/worker-entry");
		durableNamespaces: "PartitionDO" | "TransactionCoordinatorDO" | "CustomPartitionDO" | "ControlledPartitionDO" | "ControlledTransactionCoordinatorDO" | "ErrorProbeDO" | "CounterPartitionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FOKOS_SHOULD_FETCH_COLO_INFO">> {}
}
